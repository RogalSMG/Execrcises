...
public class Logic1 {
    ...
    public String fizzString(String str) {
        ...
        boolean firstMatch = first == 'f';
        boolean lastMatch = last == 'b';
    ...
    public boolean nearTen(int num) {
        int rest = num % 10;
        int range = 2;
        return (rest <= range || rest >= 10 - range);
    }
     ...
     * @param c third given number
     * @return true if sum of any two given number equals third
     */
